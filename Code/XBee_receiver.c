...
//    drive_speed(15, 15);
    drive_setRampStep(5);                        // was 12    7 ticks/sec / 20 ms
...
//    else
//      drive_rampStep(t_speed/1.5, t_speed/1.5);


  //  print("%c dist: %d  distHI: %d  distLO:  %d    %d    %d    Time: %d %c", HOME, dist, distHI, distLO, x, y, time_passed, CLREOL);
...
// Initializing the XBee, some settings are router specific
  ...
  else
  {
    ...
    print("cmd = ATIDFRITZ!Box 6490 Cable\n");
    xbcmd("ATIDFRITZ!Box 6490 Cable\r", response, 10, 200);
    print("reply = %s", response); 
    ...
    print("cmd = ATPK36393045741414980159\n");
    xbcmd("ATPK36393045741414980159\r", response, 20, 200);
    print("reply = %s", response); 

    print("cmd = ATMY192.168.178.215\n");
    xbcmd("ATMY192.168.178.215\r", response, 15, 200);
    print("reply = %s", response); 

//    print("cmd = ATMY\n");
//    xbcmd("ATMY\r", response, 10, 200);
//    print("reply = %s", response); 
...
//    print("cmd = ATRO03\n");
//    xbcmd("ATRO03\r", response, 10, 200);
//    print("reply = %s", response); 
